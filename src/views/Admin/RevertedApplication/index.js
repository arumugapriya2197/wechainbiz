...
import { reverteddata } from "./data.json";
...
const RevertedApplication = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: "Total number of Downloaded files",
        accessor: "downloadedfiles",
      },
        ...
        <Container fluid>
          <div className="d-flex align-items-center  mb-3">
            ...
            <h6 className="app-title m-0">
              <span>Reverted</span> Application - 001
            </h6>
          </div>
            ...
            <Row>
              <Col sm={8}>
                <FormField
                  ...
                  type="textarea"
                  rows={6}
                  placeholder="Need more Documents"
                  {...fieldProps("remarks")}
                />
              </Col>
            </Row>
...
export default RevertedApplication;
