...
const Enquiries = ({ userDetails }) => {
  ...
  const {
    ...
    initialValues: {
      ...
      ifsc_code: userDetails && userDetails.ifsc_code,
      no_of_employess: userDetails && userDetails.no_of_employees,
      annual_tunover: userDetails && userDetails.annual_tunover,
      email: userDetails && userDetails.email,
      mobile_no: userDetails && userDetails.mobile_no,
      enquiry_title: "",
      discription: "",
    },
            ...
            >
              ...
              <Row>
                ...
                <Col sm={4}>
                  ...
                  >
                    <option>
                      {userDetails && userDetails.no_of_employees}
                    </option>
